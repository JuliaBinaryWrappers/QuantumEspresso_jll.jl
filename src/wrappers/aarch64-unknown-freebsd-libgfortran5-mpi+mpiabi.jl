# Autogenerated wrapper script for QuantumEspresso_jll for aarch64-unknown-freebsd-libgfortran5-mpi+mpiabi
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, FFTW_jll, Libxc_jll, OpenBLAS32_jll, SCALAPACK32_jll, mpif_jll, MPIABI_jll, MPIPreferences)
